...
public class RedBlackNode {
	...
	public void inOrderWalk() {
		if (left != null)
			left.inOrderWalk();
		try {
			System.out.println("value, color, black-height: " + key.getValue()
					+ " " + getColor() + " " + getBHeight());
		...
		if (left != null) {
			...
			System.out.println("Left: " + key1.getValue() + " "
					+ left.getColor() + " " + left.getBHeight());
		}
		if (right != null) {
			Key key2 = right.getKey();
			System.out.println("Right: " + key2.getValue() + " "
					+ right.getColor() + " " + right.getBHeight());
		}
		if (prev != null) {
			Key key3 = prev.getKey();
			System.out.println("Prev: " + key3.getValue() + " "
					+ prev.getColor() + " " + prev.getBHeight());
		}
		if (next != null) {
			Key key4 = next.getKey();
			System.out.println("Next: " + key4.getValue() + " "
					+ next.getColor() + " " + next.getBHeight());
		}
		System.out.println(" ");
		if (right != null)
			right.inOrderWalk();
	...
	public RedBlackNode getSuccessor() {
		...
		for (redblacknode1 = parent; redblacknode1 != null
				&& redblacknode1.right == redblacknode; redblacknode1 = redblacknode1.parent)
			redblacknode = redblacknode1;
	...
	public RedBlackNode getPredecessor() {
		...
		RedBlackNode redblacknode1;
		for (redblacknode1 = parent; redblacknode1 != null
				&& redblacknode1.left == redblacknode; redblacknode1 = redblacknode1.parent)
			redblacknode = redblacknode1;
