...
public final class RedBlackTree {
	...
	public Vector<RedBlackNode> nodesBetween(double d, double d1) {
		...
		if (redblacknode.getKey().getValue() >= d) {
			for (RedBlackNode redblacknode1 = redblacknode.getPrev(); redblacknode1 != null
					&& redblacknode1.getKey().getValue() >= d; redblacknode1 = redblacknode
					.getPrev())
				redblacknode = redblacknode1;

		} else {
			for (redblacknode = redblacknode.getNext(); redblacknode != null
					&& redblacknode.getKey().getValue() < d; redblacknode = redblacknode
					.getNext())
				;
		}
		if (redblacknode == null || redblacknode.getKey().getValue() > d1)
			return vector;
		for (; redblacknode != null && redblacknode.getKey().getValue() <= d1; redblacknode = redblacknode
				.getNext())
	...
	public Vector<RedBlackNode> allNodes() {
		if (root == null)
			return null;
		Vector<RedBlackNode> vector = new Vector<RedBlackNode>();
		for (RedBlackNode redblacknode = getMinimum(); redblacknode != null; redblacknode = redblacknode
				.getNext())
			vector.addElement(redblacknode);
	...
	public boolean treeInsert(RedBlackNode redblacknode) {
		...
		while (redblacknode1 != null) {
			...
			else if (redblacknode.getKey().largerThan(redblacknode1.getKey()))
		...
		if (redblacknode2 == null)
			root = redblacknode;
		else if (redblacknode.getKey().lessThan(redblacknode2.getKey()))
	...
	private void RBDeleteFixUp(RedBlackNode redblacknode, int i,
			RedBlackNode redblacknode1) {
		int j;
		if (redblacknode == null)
			j = 1;
			...
			if (k1 == 1) {
				...
				if (k == 1 && i1 == 1) {
					...
					if (i1 == 1) {
						...
						redblacknode3.setColor(0);
						redblacknode3
								.setBHeight(redblacknode3.getBHeight() - 1);
					...
					if (redblacknode2.getColor() == 1) {
						redblacknode2
								.setBHeight(redblacknode2.getBHeight() - 1);
						redblacknode3
								.setBHeight(redblacknode3.getBHeight() + 1);
					}
					redblacknode2.setColor(1);
					redblacknode3.getRight().setBHeight(
							redblacknode3.getRight().getBHeight() + 1);
					leftRotate(redblacknode2);
					redblacknode = root;
				}
			} else {
				...
				if (l == 1 && j1 == 1) {
					...
					if (l == 1) {
						...
						redblacknode4.setColor(0);
						redblacknode4
								.setBHeight(redblacknode4.getBHeight() - 1);
					...
					redblacknode2.setColor(1);
					redblacknode4.getLeft().setBHeight(
							redblacknode4.getLeft().getBHeight() + 1);
					rightRotate(redblacknode2);
					redblacknode = root;
				}
			}
	...
	public boolean checkHeight() {
		...
		while (redblacknode != null)
			...
			else if (redblacknode.getRight() != null && !flag)
				redblacknode = redblacknode.getRight();
			else if (redblacknode == root) {
				redblacknode = null;
			} else {
				int i;
	...
	public boolean isInOrder() {
		...
		Object obj = null;
		for (RedBlackNode redblacknode1 = redblacknode.getNext(); redblacknode1 != null; redblacknode1 = redblacknode1
				.getNext()) {
		...
		for (RedBlackNode redblacknode2 = redblacknode3.getPrev(); redblacknode2 != null; redblacknode2 = redblacknode2
				.getPrev()) {
