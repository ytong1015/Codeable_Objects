...
public class Face {
	...
	private Vector<HalfEdge> innerComponent;
	...
	public Face(HalfEdge outer, int id){
		...
		this.setInnerComponent(new Vector<HalfEdge>());
	}
	...
	public void setInnerComponent(Vector<HalfEdge> innerComponent) {
		this.innerComponent = innerComponent;
	}


	public Vector<HalfEdge> getInnerComponent() {
